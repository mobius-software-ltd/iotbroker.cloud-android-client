...
import com.mobius.software.android.iotbroker.main.adapters.TopicsListAdapter;
...
//				}
	...
	private void refresh() {
		AccountsDao accountDao = ((AccountsDao) DaoObject.getDao(getActivity(), DaoType.AccountsDao));
		List<Accounts> accountsList = accountDao.queryBuilder().where(com.mobius.software.android.iotbroker.main.dal.AccountsDao.Properties.IsDefault.eq(1)).list();
		...
		topicsList = topicDao
				.queryBuilder()
				.where(com.mobius.software.android.iotbroker.main.dal.TopicsDao.Properties.AccountID.eq(currAccount
						.getId())).list();
