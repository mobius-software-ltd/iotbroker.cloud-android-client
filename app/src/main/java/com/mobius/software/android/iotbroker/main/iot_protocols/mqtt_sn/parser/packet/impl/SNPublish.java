...
public class SNPublish extends CountableMessage
{
	...
	public SNPublish(Integer packetID, Topic topic, ByteBuf content, boolean dup, boolean retain)
	{
		super(packetID);
		this.topic = topic;
	...
	public SNPublish reInit(Integer packetID, Topic topic, ByteBuf content, boolean dup, boolean retain)
	{
	...
	public int getType()
	{
		return SNType.PUBLISH.getValue();
	}
