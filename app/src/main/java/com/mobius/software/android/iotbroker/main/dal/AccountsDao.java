...
public class AccountsDao extends AbstractDao<Accounts, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property IsSecureConnection = new Property(14, Boolean.class, "isSecureConnection", false, "IS_SECURE_CONNECTION");
        public final static Property CertificatePath = new Property(15, String.class, "certificatePath", false, "CERTIFICATE_PATH");
        public final static Property CertificatePassword = new Property(16, String.class, "certificatePassword", false, "CERTIFICATE_PASSWORD");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ACCOUNTS\" (" + //
                ...
                "\"IS_SECURE_CONNECTION\" INTEGER," + // 14: isSecureConnection
                "\"CERTIFICATE_PATH\" TEXT," + // 15: certificatePath
                "\"CERTIFICATE_PASSWORD\" TEXT);"); // 16: certificatePassword
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Accounts entity) {
        ...
        Boolean isSecureConnection = entity.getIsSecureConnection();
        if (isSecureConnection != null) {
            stmt.bindLong(15, isSecureConnection ? 1L: 0L);
        }
 
        String certificatePath = entity.getCertificatePath();
        if (certificatePath != null) {
            stmt.bindString(16, certificatePath);
        }
 
        String certificatePassword = entity.getCertificatePassword();
        if (certificatePassword != null) {
            stmt.bindString(17, certificatePassword);
        }
    }
    ...
    public Accounts readEntity(Cursor cursor, int offset) {
        Accounts entity = new Accounts( //
            ...
            cursor.isNull(offset + 14) ? null : cursor.getShort(offset + 14) != 0, // isSecureConnection
            cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15), // certificatePath
            cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16) // certificatePassword
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Accounts entity, int offset) {
        ...
        entity.setIsSecureConnection(cursor.isNull(offset + 14) ? null : cursor.getShort(offset + 14) != 0);
        entity.setCertificatePath(cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15));
        entity.setCertificatePassword(cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16));
     }
