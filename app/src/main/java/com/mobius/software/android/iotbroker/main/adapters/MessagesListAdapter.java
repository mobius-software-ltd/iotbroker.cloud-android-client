...
public class MessagesListAdapter extends BaseAdapter {
	...
	private static final String QOS_TITLE = "QOS : ";
	private static final String MESSAGE_IN_TEXT = "in";
	private static final String MESSAGE_OUT_TEXT = "out";

	private LayoutInflater lInflater;
	private List<Messages> objects;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String isIncominText = messageItem.getIsIncoming() ? MESSAGE_IN_TEXT : MESSAGE_OUT_TEXT;
