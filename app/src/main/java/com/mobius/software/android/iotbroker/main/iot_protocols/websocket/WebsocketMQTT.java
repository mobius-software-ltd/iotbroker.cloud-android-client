package com.mobius.software.android.iotbroker.main.iot_protocols.websocket;
...
public class WebsocketMQTT implements IotProtocol {
    ...
    public void closeConnection() {
        ...
        if (client != null) {
            WebsocketClient currClient = client;
            client = null;
            currClient.shutdown();
        }
    }
